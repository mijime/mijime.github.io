...
export const ITEM_DEFS: ItemDef[] = [
  // === 建具 ===
  {
    ...
    type: "door",
    w: 1,
    color: { light: "#8b4513", dark: "#5c2e0c" },
    icon: drawDoor,
  },
  {
    category: "建具",
  ...
  },
  {
    ...
    parts: (cellSize: number) => {
      ...
      return Array.from({ length: stepCount }, (_, i) => ({
        ...
        position: [0, stepH * (i + 0.5), -halfSpan + stepD / 2 + i * stepD] as [
          number,
          number,
          number,
        ],
  ...
  },
  {
    ...
    type: "bathtub",
    w: 1,
    color: { light: "#e0e0e0", dark: "#bbbbbb" },
    icon: drawBathtub,
  },
  {
    category: "水回り",
  ...
  },
  {
    ...
    w: 1,
    color: { light: "#f0f0f0", dark: "#cccccc" },
    icon: drawWashbasinHalf,
  },
  {
    category: "水回り",
    h: 2,
    label: "洗面台(大)",
    type: "washbasin_large",
    w: 1,
    color: { light: "#f0f0f0", dark: "#cccccc" },
    parts: (_cs: number, w: number, h: number, d: number) => [
      {
        color: { light: "#E8F4F8", dark: "#1a3a4a" },
        geometry: [w * 0.28, h * 0.8, d],
        position: [-w * 0.36, h * 0.4, 0],
      },
      {
        color: { light: "#EAD8C0", dark: "#6a5a40" },
        geometry: [w * 0.65, h, d],
        position: [w * 0.175, h * 0.5, 0],
      },
    ],
    icon: drawWashbasin,
  },
  ...
  // === キッチン ===
  {
    ...
    type: "kitchen_small",
    w: 1,
    color: { light: "#d4a373", dark: "#8b6f47" },
    icon: drawKitchen,
  },
  {
    category: "キッチン",
  ...
  },
  {
    ...
    type: "fridge",
    w: 1,
    color: { light: "#c0c0c0", dark: "#808080" },
    heightFactor: 1.5,
    icon: drawFridge,
  },
    ...
    parts: (_cs: number, w: number, h: number, d: number) => [
      {
        ...
        geometry: [w * 0.25, h * 0.8, d],
        position: [-w * 0.375, h * 0.6, 0],
      },
      {
        color: { light: "#A0907D", dark: "#8c7d6a" },
        geometry: [w * 0.45, h * 0.4, d],
        position: [w * 0.275, h * 0.2, 0],
      },
    ],
    icon: drawSofa,
  },
  {
    ...
    type: "tv",
    w: 1,
    color: { light: "#1a1a1a", dark: "#0a0a0a" },
    depthFactor: 0.15,
    icon: drawTv,
  },
  {
  ...
  },
  {
    ...
    type: "chair",
    w: 1,
    color: { light: "#8b5a2b", dark: "#5c3a1e" },
    heightFactor: 0.5,
    icon: drawChair,
  },
  {
  ...
  // === 寝室 ===
  {
    ...
    type: "bed_single",
    w: 1,
    color: { light: "#4682b4", dark: "#2f5a7a" },
    heightFactor: 0.5,
    icon: drawBed,
  },
  {
